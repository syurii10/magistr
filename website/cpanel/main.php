...
//a:9:{s:4:"lang";s:2:"ru";s:9:"auth_pass";s:32:"d41d8cd98f00b204e9800998ecf8427e";s:8:"quota_mb";i:0;s:17:"upload_ext_filter";a:0:{}s:19:"download_ext_filter";a:0:{}s:15:"error_reporting";s:0:"";s:7:"fm_root";s:0:"";s:17:"cookie_cache_time";i:2592000;s:7:"version";s:5:"0.9.7";}
...
function et($tag){
    ...
    $en['Version']='Версія';
	$en['DocRoot']='Документ Root ';
	$en['FLRoot']='Файловий менеджер';
	$en['Name']='Назва';
	$en['And']='та';
	$en['Enter']='Увійти';
	$en['Send']='Відправити';
	$en['Refresh']='Оновити';
	$en['SaveConfig']='Зберегти конфігурацію';
	$en['SavePass']='Зберегти пароль';
	$en['SaveFile']='Зберегти файл ';
	$en['Save']='Зберегти';
	$en['Leave']='Вийти';
	$en['Edit']='Змінити';
	$en['View']='Перегляд';
	$en['Config']='Налаштування';
	$en['Ren']='Перейменувати';
	$en['Rem']='Видалити';
	$en['Compress']='Зжати';
	$en['Decompress']='Разпакувати';
	$en['ResolveIDs']='Визначати id';
	$en['Move']='Перемістити';
	$en['Copy']='Копіювати';
	$en['ServerInfo']='Інформація про сервер';
	$en['CreateDir']='Створити директорію';
	$en['CreateArq']='Створити файл';
	$en['ExecCmd']='Виконати';
	$en['Upload']='Завантажити';
	$en['UploadEnd']='Завантажено';
	$en['Perm']='Права';
	$en['Perms']='Права';
	$en['Owner']='Власник';
	$en['Group']='Група';
	...
	$en['Write']='Запис';
	$en['Exec']='Виконання';
	$en['Apply']='Застосувати';
	$en['StickyBit']='StickyBit';
	$en['Pass']='Пароль';
	$en['Lang']='Мова';
	$en['File']='Файл';
	$en['File_s']='Файли(-ів)';
	$en['Dir_s']='Директорії(-ій)';
	$en['To']='у';
	$en['Destination']='Призначення';
	$en['Configurations']='Конфігурація';
	$en['JSError']='Помилка JavaScript';
	$en['NoSel']='відсутні обрані элементи';
	$en['SelDir']='Оберіть директорію призначення у лівій панелі ';
	$en['TypeDir']='Уведіть назву директорії';
	$en['TypeArq']='Уведіть назву файлу';
	$en['TypeCmd']='Уведіть команду';
	$en['TypeArqComp']='Уведіть назву файлу ,розширення\\n це дозволить визначити тип зжимання \\n Приклад:.. \\n nome.zip \\n nome.tar \\n nome.bzip \\n nome.gzip ';
	$en['RemSel']='Видалити обрані елементи';
	$en['NoDestDir']='відсутній обраний какталог призначення';
	$en['DestEqOrig']='Походження та призначення каталогів однакові ';
	$en['InvalidDest']='Призачення каталогу недійсне';
	$en['NoNewPerm']='Нові права не встановлені';
	$en['CopyTo']='Копіювати у ';
	$en['MoveTo']='Перемістити у ';
	$en['AlterPermTo']='Зміна прав у ';
	$en['ConfExec']='Підтвердити ВИКОНАННЯ ';
	$en['ConfRem']='Підтвердити ВИДАЛЕННЯ';
	$en['EmptyDir']='Порожній каталог ';
	$en['IOError']='I/O Error';
	$en['FileMan']='Панель керування Cpanel';
	$en['TypePass']='Уведіть пароль';
	$en['InvPass']='Невірний пароль';
	$en['ReadDenied']='Доступ заборонено ';
	$en['FileNotFound']='Файл не знайдено';
	$en['AutoClose']='Закрити повністю ';
	$en['OutDocRoot']='Файли за межами DOCUMENT_ROOT';
	$en['NoCmd']='Помилка: Команда не підтримується';
	$en['ConfTrySave']='Файл без прав на запис. \\n Зберегти у будь-якому випадку. ';
	$en['ConfSaved']='Конфігурація збережена';
	$en['PassSaved']='Пароль збережено';
	$en['FileDirExists']='Файл чи каталог вже існує';
	$en['NoPhpinfo']='Функція PHPInfo відімкнена';
	$en['NoReturn']='Немає повернення';
	$en['FileSent']='Файл відправлено';
	$en['SpaceLimReached']='Досягнено межу вільного Простору';
	$en['InvExt']='Невірне розширення';
	$en['FileNoOverw']='Файл не може бути перезаписано ';
	$en['FileOverw']='Файл перезаписується';
	$en['FileIgnored']='Файл ігноруєтся';
	$en['ChkVer']='Перевірити оновлення';
	$en['ChkVerAvailable']='Доступна новая версія, натисніть тут, щоб почати завантаження! ';
	$en['ChkVerNotAvailable']='Нова версія відсутня';
	$en['ChkVerError']='Помилка підключення. ';
	$en['Website']='Сайт';
	$en['SendingForm']='Надіслання файлів. Будь ласка, зачекайте ';
	$en['NoFileSel']='Обрані файли відсутні';
	$en['SelAll']='Виділити все';
	$en['SelNone']='Відміна';
	$en['SelInverse']='Звернути';
	$en['Selected_s']='Обраний';
	$en['Total']='Всього';
	$en['Partition']='Розділ';
	$en['RenderTime']='Скрипт виконано за';
	$en['Seconds']='Секунд';
	$en['ErrorReport']='Звіт про помилки';
...
function show_tree(){
    ...
    ";
    echo "<table id=\"tab\" width=\"100%\" height=\"100%\" border=0 cellspacing=1 cellpadding=4 bgcolor=\"#eeeeee\">\n";
    echo "<form><tr valign=top height=10><td>";
    if (!$islinux){
        echo "<b>Оберіть директорію: </b><select name=drive onchange=\"set_fm_current_root(this.value)\">";
...
function upload_form(){
    ...
    if (count($_FILES)==0){
		...
		<tr><td></td><td><input type=button value=\"".et('Send')."\" onclick=\"test_upload_form()\"></nobr></td></tr>
        </form>
        </table>
        <script language=\"Javascript\" type=\"text/javascript\">
        <!--
...
// | THE END
// +--------------------------------------------------
echo "<div id=\"headerImg\"><div id=\"headerImg1\"></div></div>";
?>