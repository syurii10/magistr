...
function setupDashboardChart(containerElementId) {
    var s1 = [2500, 300, 400, 500, 600, 700, 800, 900, 1000];
    ...
    var ticks = ['Березень', 'Квітень', 'Травень', 'Червень', 'Липень', 'Серпень', 'Вересень', 'Жовтень', 'Листопад'];
    ...
    var plot1 = $.jqplot(containerElementId, [s1, s2, s3, s4], {
        ...
        axes: {
            ...
            yaxis: {
                pad: 1.05,
                tickOptions: { formatString: '%d чол.' }
            }
        }
    });
}
